  ...
  return (
    <section className='w-full bg-[#F5F5F5] '>
     <main className='mx-auto max-w-[70rem] md:p-0 p-5 '>
       ...
       <h2 className='font-medium md:text-[32px] text-[22px] text-[#5D3BEE]  pt-16'>What is cddsoir  hourly rate?</h2>
       <div className='flex justify-between pt-5'>
           <h1 className='font-normal md:text-[18px] text-[12px] text-[#51586A] '>Lorem ajdkc dolir sit amet, consectetur adipiscing elit. In <br /> urna, non nisl tincidunt ut elementum turpis.</h1>
